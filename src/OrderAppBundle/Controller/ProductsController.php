...
use OrderAppBundle\Entity\Products;
...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('OrderAppBundle:Products')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OrderAppBundle\Form\ProductsType', $product);
        $form->handleRequest($request);

        $product->setName($request->get('name'));
        $product->setStock($request->get('stock'));
        $product->setPrice($request->get('price'));
        $product->setPriceKg($request->get('price_kg'));
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('OrderAppBundle\Form\ProductsType', $product);
